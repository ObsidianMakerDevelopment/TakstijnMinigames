...
public class SudoCommand extends CommandManager.Command {
    ...
    private void commandMake(final @NotNull CommandSender player,
    ...
    @CommandPermission("obsidian.make")
    private void commandMakeEveryone(final @NotNull CommandSender player, final @Greedy @Argument("command") String command) {
    ...
    private void commandSudo(final @NotNull CommandSender player, final @Greedy @Argument("command") String command) {
