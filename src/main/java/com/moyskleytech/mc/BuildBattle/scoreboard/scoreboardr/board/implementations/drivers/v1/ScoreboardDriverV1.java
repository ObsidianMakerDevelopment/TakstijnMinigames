package com.moyskleytech.mc.BuildBattle.scoreboard.scoreboardr.board.implementations.drivers.v1;
...
import com.moyskleytech.mc.BuildBattle.scoreboard.scoreboardr.board.implementations.IBoard;
import com.moyskleytech.mc.BuildBattle.scoreboard.scoreboardr.plugin.Session;
import com.moyskleytech.mc.BuildBattle.scoreboard.scoreboardr.plugin.utility.LineLimits;
...
public class ScoreboardDriverV1 implements IBoard {
    ...
    private String objectiveName = "buildbattle";
    ...
    public void setPlayer(Player player) {
        ...
        this.board = Objects.requireNonNull(Session.getSession().plugin.getServer().getScoreboardManager())
                .getNewScoreboard();
        this.objective = this.board.registerNewObjective(objectiveName, Criteria.DUMMY, Component.empty());
    ...
    public void setTitle(String title) {
        ...
        this.objective.displayName(ObsidianUtil.component(title));
    }
