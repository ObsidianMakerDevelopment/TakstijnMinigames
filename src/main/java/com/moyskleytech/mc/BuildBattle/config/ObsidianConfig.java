...
public class ObsidianConfig extends Service {
    ...
    public void loadDefaults() {
        ...
        try {
            ...
            generator.start()
                    ...
                    .key("name").defValue("&f[<RAINBOW1>BuildBattle</RAINBOW>&f]")
                    .section("afk")
    ...
    public  StarterKitConfig starterKit() {
    ...
    public  SkyblockConfig skyblock() {
    ...
    public  MangroveConfig mangrove() {
    ...
    public  JoinLeaveConfig joinLeave() {
    ...
    public  EssentialsConfig essentials() {
    ...
    public  VoidConfig voidTeleport() {
